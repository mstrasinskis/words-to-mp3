...
Set both `OPENAI_API_KEY` and `TSV_PATH` before running. `START_INDEX` remains optional and prefixes output files with a zero-padded sequence such as `001.`, `099.`, or `240.`.
